 ...
 *</p>
 */
public class ConfigConnectionMapDialog
  extends JDialog
{
  ...
  ConfigConnectionMapPanel m_configConnectionMapPanel = new ConfigConnectionMapPanel();
  ...
  public ConfigConnectionMapDialog(Component frame, String strAppName, String title, boolean modal, Vector cm, Vector listener, String servletUrl, JTextArea ta, AppProperties appProps)
  {
    ...
    m_jTextAreaOut = ta;
    m_appProps = appProps;
    m_configConnectionMapPanel.setFrame( m_frame);
    m_configConnectionMapPanel.setConnectionMapVector( cm);
    m_configConnectionMapPanel.setListenerVector( listener);
    m_configConnectionMapPanel.setServletUrl( m_servletUrl);
    m_configConnectionMapPanel.setOutputTextArea( ta);
    m_configConnectionMapPanel.setAppProperties( appProps);
    try
    {
      jbInit();
      pack();
  ...
  public ConfigConnectionMapDialog( Component frame, String strAppName, Vector cm, Vector listener, String servletUrl, JTextArea ta, AppProperties appProps)
  {
    this( frame, strAppName, "Config map configuration", true, cm, listener, servletUrl, ta, appProps);
  }

  /*
  public ConfigConnectionMapDialog()
  {
  ...
  */
  ...
  void jbInit() throws Exception
  {
    ...
    m_panelBase.add(m_configConnectionMapPanel, BorderLayout.CENTER);
  ...
  {
    m_configConnectionMapPanel.m_jButtonSet_actionPerformed(e);
    setVisible( false);
  }

  public Vector getConnectionMap()
  {
    return m_configConnectionMapPanel.getConnectionMap();
  }
  ...
  public void setVisible( boolean b)
  {
    ...
    m_configConnectionMapPanel.requestFocus();
    super.setVisible( b);
  }
}

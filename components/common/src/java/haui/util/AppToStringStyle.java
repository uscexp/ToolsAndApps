...
public class AppToStringStyle implements Serializable
{
  ...
  private static final class DTOToStringStyle extends ToStringStyle
  {
    ...
    /**
     * Append to the toString() an <code>Object</code> value, printing the a) toString() that would
     * be produced by <code>Object</code> if a class did not override toString() itself
     * <code>Object</code> or else b) the full detail of the <code>Object</code>.
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     * @param fieldName the field, typically not used as already appended
     * @param value the value to add to toString(), not <code>null</code>
     */
    ...
    /**
     * Append the run-time type and size of a <code>Collection</code> to the <code>toString()</code>
     * .
     */
    ...
    /**
     * Append the run-time type and size of a <code>Map</code> to the <code>toString()</code>.
     */
    ...
    /**
     * Append the class name and the size of e.g. a Collection, a Map, Array etc.
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     * @param clazz the class to append
     * @param size the size to append
     */
    protected void appendSummarySet(StringBuffer buffer, Class clazz, int size)
    {
     ...
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     * @param name the type name to append
     * @param size the size to append
     */
    ...
    /**
     * Append the <code>AbstractCode</code> class name and the code attribute.
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     * @param vsc the <code>AbstractCode</code> object containing the code
     */
    protected void appendSummary(StringBuffer buffer, haui.model.data.Enum vsc)
    {
     ...
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     * @param fe the <code>DataTransferObject</code>
     */
    ...
    /**
     * Append the date formatted using the date format defined in {@link DateUtil#DATE_FORMAT}.
     * 
     * @param buffer the <code>StringBuffer</code> to populate
     * @param date the <code>Date</code> to be appended
     */

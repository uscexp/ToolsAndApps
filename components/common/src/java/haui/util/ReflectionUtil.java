...
public class ReflectionUtil {
     ...
     * @throws SecurityException
     */
    public static final Method getDeclaredGetMethod(Class<?> clazz, String pnAttribute) throws IllegalArgumentException, IllegalAccessException, SecurityException, NoSuchMethodException {
        Field field = null;
    ...
    public static Constructor<?> getConstructor(Class<?> clazz, Class<?>... parameterTypes) {
        ...
        try {
            ...
            throw new AppSystemException(String.format("Constructor %s not found in class %s", getMethodSignature(clazz.getSimpleName(), parameterTypes), clazz), nsme);
        }
        return constructor;
    }
    ...
    private static boolean compareMethodWithSpecs(Method aMethod, String aMethodName, Class<?>[] aParamTypes, Class<?> aReturnType) {
        ...
        return (aMethod.getName().equalsIgnoreCase(aMethodName) && (aReturnType == null || aReturnType.equals(aMethod.getReturnType())) && (aParamTypes == null || compareClassArrays(aParamTypes,
    ...
    public static Object invokeStaticMethod(Class<?> clazz, String name, Class<?>[] parameterTypes, Object[] parameters) throws SecurityException, NoSuchMethodException, IllegalArgumentException,
     ...
     *            {@code Class<?>} object will be instantiated.
     * @param args
     *            object array of constructor arguments. no null arguments
     *            allowed.
     * @return a newly allocated instance of the class represented by the
     *         invoked {@code Type} object.
     * 
     ...
     * @see {@link Class<?>#newInstance()}
     */
    public static Object newInstance(Type type, Class<?>[] parameterTypes, Object... args) {
        Object object = null;
        try {
            Class<?> clazz = getClass(type);
            if (clazz != null) {
            ...
            throw new AppSystemException(String.format("Class not found for type ", type.toString()), cnfe);
        } catch (InstantiationException | IllegalAccessException | IllegalArgumentException | InvocationTargetException e) {
            throw new AppSystemException(String.format("Could not instanciate new object for type %s", type.toString()), e);
        }
        return object;
    }

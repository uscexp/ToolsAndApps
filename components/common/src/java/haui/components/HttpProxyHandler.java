...
/**
 * Module: HttpProxyHandler.java<br>
 * $Source:
 * M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\components
 * \\HttpProxyHandler.java,v $
 * <p>
 * Description: Handels HTTP proxies.<br>
 * </p>
 * <p>
 ...
 *          <p>
 *          Modification:<br>
 *          $Log: HttpProxyHandler.java,v $ Revision 1.3 2004-08-31 16:03:11+02
 ...
 *          features for jDirWork. Revision 1.2 2003-05-28 14:19:54+02 t026843
 *          reorganisations Revision 1.1 2002-01-15 11:14:25+01 t026843 Data
 *          header changed to a dynamic header and extended with host and port
 *          Revision 1.0 2000-10-05 14:48:41+02 t026843 Initial revision
 *          </p>
 *          <p>
 ...
 *          components\\HttpProxyHandler.java,v 1.3 2004-08-31 16:03:11+02
 *          t026843 Exp t026843 $
 *          </p>
 *          <p>
 * @since JDK1.2
...
public class HttpProxyHandler {
	...
	public ProxyPropertiesDialog showProxyPropertiesDialog(Frame frame) {
		m_propsDlg = new ProxyPropertiesDialog(frame, "proxy settings", true,
				m_appProps, m_strAppName);
	...
	public void getAllProperties() {
		if (m_appProps != null) {
			m_blProxy = m_appProps.getProperty(
					GlobalApplicationContext.PROXYENABLE, false);
			m_strProxyHost = m_appProps
					.getProperty(GlobalApplicationContext.PROXYHOST);
			m_iProxyPort = (new Integer(
					m_appProps.getProperty(GlobalApplicationContext.PROXYPORT)))
					.intValue();
			;
			m_strUsr = m_appProps
	...
	public String getAuthorization() {
		...
		if (m_auth == null) {
			...
			System.getProperties().put("https.proxySet",
					String.valueOf(useProxy()));
			...
			if (getUser() == null || getPassword() == null
				...
				PasswordAuthentication pw = new PasswordAuthentication(
						getUser(), getPassword().toCharArray());

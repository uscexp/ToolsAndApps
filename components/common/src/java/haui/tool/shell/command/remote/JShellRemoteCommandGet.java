  ...
  extends JShellCommandDefault
{
  ...
  {
    setCommand( (new JShellCommandProcessor( jse, "get")).getCommandLineContainer());
    ...
    throws haui.tool.shell.engine.JShellException
  {
    ...
    if( strArgs != null && strArgs.length > 0 && hmOptions.size() >= 0)
    {
      ...
      FileInterfaceConfiguration fic = FileConnector.createFileInterfaceConfiguration( null, 0, null, fiLocal.getConnObj(), 0, 0,

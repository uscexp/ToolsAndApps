 ...
 * \\command\\JShellCommandFtp.java,v $
 * <p>
 ...
 *          <p>
 *          Modification:<br>
 *          $Log: JShellCommandFtp.java,v $ Revision 1.1 2004-08-31 16:03:23+02
 ...
 * 
 *          Revision 1.0 2004-06-22 14:06:45+02 t026843 Initial revision
 * 
 *          </p>
 *          <p>
 ...
 *          app\\Shell\\command\\JShellCommandFtp.java,v 1.1 2004-08-31
 *          16:03:23+02 t026843 Exp t026843 $
 *          </p>
 *          <p>
 * @since JDK1.3
 *        </p>
 */
public class JShellCommandFtp extends JShellCommandDefault {
    String m_strUrl = null;
    String m_strUser = null;
    String m_strPwd = null;

    public JShellCommandFtp(JShellEnv jse) {
        setCommand((new JShellCommandProcessor(jse, "ftp")).getCommandLineContainer());
    ...
    public int processCommand(JShellEnv jse, CommandLineContainer clc) throws haui.tool.shell.engine.JShellException {
        ...
        if (strArgs.length == 1) {
            ...
            FtpConnectionObject f = new FtpConnectionObject(ftpUrl.getHost(), ftpUrl.getPort(), m_strUser, m_strPwd, Protokoll.FTP);
            try { /* connect & login to host */
                FileInterfaceConfiguration fic = FileConnector.createFileInterfaceConfiguration(null, 0, null, f, 0, 0, jse.getAppName(), jse.getAppPropperties(), true);
                FileInterface fiFtp = FileConnector.createFileInterface(ftpUrl.getPath(), null, false, fic);

 ...
 * $Source: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\app\\Shell\\command\\JShellCommandJexec.java,v $ <p> Description: execute java programs.<br>
 * </p><p>
 ...
 * </p><p>
 * Modification:<br>
 * $Log: JShellCommandJexec.java,v $  Revision 1.1  2004-08-31 16:03:00+02  t026843  Large redesign for application dependent outputstreams, mainframes, AppProperties!  Bugfixes to DbTreeTableView, additional features for jDirWork.  Revision 1.0  2004-06-22 14:06:46+02  t026843  Initial revision
 * </p><p>
  ...
  extends JShellCommandDefault
{
  ...
  {
    setCommand( (new JShellCommandProcessor( jse, "jexec")).getCommandLineContainer());
    ...
    throws haui.tool.shell.engine.JShellException
  {
    ...
    if( strArg != null && !strArg.equals( ""))
    {
      ...
      if( strPath != null)
      {
        ...
        while( stPath.hasMoreTokens())
        {
          ...
          if( !str.equals( "."))
          {
            ...
            FileInterface fiTmp = FileConnector.createFileInterface( str, null, false, fic);
            if( !fiTmp.exists() )
            {
              StringBuffer stTmp = new StringBuffer( fi.getAbsolutePath() );
              stTmp.append( fi.separatorChar() );
              stTmp.append( str );
              fic = FileConnector.createFileInterfaceConfiguration( null, 0, null, fi.getConnObj(), 0, 0,
                  jse.getAppName(), jse.getAppPropperties(), true);
              fiTmp = FileConnector.createFileInterface( stTmp.toString(), null, false, fic);
              if( fiTmp.exists() )
      ...
      try
      {
        ...
        JShellEnv.setClasspathToDefaultClasspath();
        strPath = JShellEnv.convertClasspathToUrlString( strbufPath.toString());
        ...
        JProcess proc = new JProcess( strMainClass, strProcArgs, jse.getAppName());
        if( m_bt != null)

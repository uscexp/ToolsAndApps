...
import haui.process.ProcessManager;
...
/**
 * Module:       JShellEnv.java<br> $Source: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\app\\Shell\\engine\\JShellEnv.java,v $ <p> Description:  Java shell environment.<br> </p><p> Created:	    23.03.2004  by AE </p><p>
 * @history       23.03.2004  by AE: Created.<br>  </p><p>  Modification:<br>  $Log: JShellEnv.java,v $  Revision 1.1  2004-08-31 16:03:02+02  t026843  Large redesign for application dependent outputstreams, mainframes, AppProperties!  Bugfixes to DbTreeTableView, additional features for jDirWork.  Revision 1.0  2004-06-22 14:06:51+02  t026843  Initial revision  </p><p>
 * @author        Andreas Eisenhauer  </p><p>
 * @version       v1.0, 2004; $Revision: 1.1 $<br>  $Header: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\app\\Shell\\engine\\JShellEnv.java,v 1.1 2004-08-31 16:03:02+02 t026843 Exp t026843 $  </p><p>
 * @since         JDK1.3  </p>
 */
public class JShellEnv
{
  ...
  private Interpreter m_bshInterpreter = null;
  ...
  public void init()
  {
    ...
    int iIdx = -1;
    if( (iIdx = strPath.lastIndexOf( File.separatorChar)) != -1 )
    {
      strPath = strPath.substring( 0, iIdx );
    }
    FileInterfaceConfiguration fic = FileConnector.createFileInterfaceConfiguration( null, 0, null, null, 0, 0, APPNAME, m_appProps, true);
    m_fi = FileConnector.createFileInterface( strPath, null, false, fic);
  ...
  {
    if( m_bshInterpreter == null)
      m_bshInterpreter = new Interpreter( new StringReader(""), getOut(), getErr(), false);

    return m_bshInterpreter;
  }

  public Interpreter getInteractiveBshInterpreter()
  {
...
//    interpreter1.run();
//
    Interpreter interpreter = new Interpreter( getIn(), getOut(), getErr(), true);
  ...
  public final String getNextLine() throws IOException
  {
    ...
    String strRead = StringUtil.readLine( getInStream() );
  ...
  public Reader getIn()
  {
    ...
    if( getInStream() == null)
      ...
      reader = new InputStreamReader( getInStream());

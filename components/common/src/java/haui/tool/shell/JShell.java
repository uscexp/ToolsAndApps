...
/**
 * Module:       JShell.java<br> $Source: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\app\\Shell\\JShell.java,v $ <p> Description:  Java shell implementation.<br> </p><p> Created:	    23.03.2004  by AE </p><p>
 * @history       23.03.2004  by AE: Created.<br>  </p><p>  Modification:<br>  $Log: JShell.java,v $  Revision 1.1  2004-08-31 16:03:02+02  t026843  Large redesign for application dependent outputstreams, mainframes, AppProperties!  Bugfixes to DbTreeTableView, additional features for jDirWork.  Revision 1.0  2004-06-22 14:06:51+02  t026843  Initial revision  </p><p>
 * @author        Andreas Eisenhauer  </p><p>
 * @version       v1.0, 2004; $Revision: 1.1 $<br>  $Header: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\app\\Shell\\JShell.java,v 1.1 2004-08-31 16:03:02+02 t026843 Exp t026843 $  </p><p>
 * @since         JDK1.3  </p>
 */
public class JShell
{
...
//      GlobalAppProperties.instance().getPrintStreamOutput( JShellEnv.APPNAME).println( "Warning : Standard system class used.\nJShell not fully functional, please use -Xbootclasspath option");
...
//    }
  ...
  static
  {
    try
    {
      GlobalApplicationContext.instance().addApplicationClass(Class.forName( "haui.app.Shell.JShell" ) );
    }
    catch( Exception e )
    {}
  }

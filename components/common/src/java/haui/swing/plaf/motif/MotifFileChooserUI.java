...
public class MotifFileChooserUI extends BasicFileChooserUI
{
  ...
  public MotifFileChooserUI(JFileInterfaceChooser filechooser)
  {
    super(filechooser);
  }
  ...
  public PropertyChangeListener createPropertyChangeListener(JFileInterfaceChooser fc)
  {
    return new PropertyChangeListener()
    {
      public void propertyChange(PropertyChangeEvent e)
      {
        ...
        if(prop.equals(JFileInterfaceChooser.SELECTED_FILE_CHANGED_PROPERTY))
        {
        ...
        else if(prop.equals(JFileInterfaceChooser.SELECTED_FILES_CHANGED_PROPERTY))
        {
        ...
        else if(prop.equals(JFileInterfaceChooser.DIRECTORY_CHANGED_PROPERTY))
        {
          ...
          FileInterface currentDirectory = getFileChooser().getCurrentDirectory();
          if(currentDirectory != null)
          {
            try
            {
              setDirectoryName(((FileInterface)e.getNewValue()).getCanonicalPath());
            }
            catch(IOException ioe)
            {
              setDirectoryName(((FileInterface)e.getNewValue()).getAbsolutePath());
            }
            if((getFileChooser().getFileSelectionMode() == JFileInterfaceChooser.DIRECTORIES_ONLY) && !getFileChooser().isMultiSelectionEnabled())
            {
              setFileName(getDirectoryName());
            }
          }
        }
        else if(prop.equals(JFileInterfaceChooser.FILE_SELECTION_MODE_CHANGED_PROPERTY))
        {
          directoryList.clearSelection();
        }
        else if(prop == JFileInterfaceChooser.MULTI_SELECTION_ENABLED_CHANGED_PROPERTY)
        {
        ...
        else if(prop == JFileInterfaceChooser.ACCESSORY_CHANGED_PROPERTY)
        {
        ...
        else if(prop == JFileInterfaceChooser.APPROVE_BUTTON_TEXT_CHANGED_PROPERTY || prop == JFileInterfaceChooser.APPROVE_BUTTON_TOOL_TIP_TEXT_CHANGED_PROPERTY
            || prop == JFileInterfaceChooser.DIALOG_TYPE_CHANGED_PROPERTY)
        {
        ...
        else if(prop.equals(JFileInterfaceChooser.CONTROL_BUTTONS_ARE_SHOWN_CHANGED_PROPERTY))
        {
  ...
  {
    return new MotifFileChooserUI((JFileInterfaceChooser)c);
  }
  ...
  protected class FileCellRenderer extends DefaultListCellRenderer
  {
    public Component getListCellRendererComponent(JList list, Object value, int index, boolean isSelected, boolean cellHasFocus)
    {
      ...
      setText(getFileChooser().getName((FileInterface)value));
      return this;
    }
  }

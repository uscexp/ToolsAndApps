...
public class PatternBasedFileFilter implements FileFilter
{
	...
	public boolean accept (File file)
	{
		...
		while (i.hasNext ())
		{
			...
			if (StringUtil.matchesPattern(sFileName, sPattern, bCaseSensitive))
				return true;
		}
	...
	public int getPatternCount () {return m_Patterns.size ();}
	public String getPattern (int nIndex) {return (String)m_Patterns.get (nIndex);}

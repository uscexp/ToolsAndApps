...
/**
 * Module:      FileTypeServer.java<br> $Source: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\io\\FileTypeServer.java,v $ <p> Description: abstract base class for FileTypeServers.<br> </p><p> Created:	    19.05.2004  by AE </p><p>
 * @history      19.05.2004  by AE: Created.<br>  </p><p>  Modification:<br>  $Log: FileTypeServer.java,v $  Revision 1.1  2004-08-31 16:03:18+02  t026843  Large redesign for application dependent outputstreams, mainframes, AppProperties!  Bugfixes to DbTreeTableView, additional features for jDirWork.  Revision 1.0  2004-06-22 14:06:56+02  t026843  Initial revision  </p><p>
 * @author       Andreas Eisenhauer  </p><p>
 * @version      v1.0, 2004; $Revision: 1.1 $<br>  $Header: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\io\\FileTypeServer.java,v 1.1 2004-08-31 16:03:18+02 t026843 Exp t026843 $  </p><p>
 * @since        JDK1.3  </p>
 */
public abstract class FileTypeServer
  implements FileInterface
{
  ...
  {
    throw new java.lang.UnsupportedOperationException("Method getBufferedInputStream() not implemented.");
  }

  public BufferedOutputStream getBufferedOutputStream(String strNewPath)
    throws FileNotFoundException
  {
    throw new java.lang.UnsupportedOperationException("Method getBufferedOutputStream(String) not implemented.");
  }
  ...
  public boolean init( String strPath)
  {
    if( m_fi != null)
    {
      ...
      {
        m_fi = FileConnector.changeDirectory( m_fi, strPath, getFileInterfaceConfiguration());
        if( getFileInterfaceConfiguration() instanceof SocketTypeServerFileInterfaceConfiguration)
          ((SocketTypeServerFileInterfaceConfiguration)getFileInterfaceConfiguration()).append(
              "Current path is " + m_fi.getAbsolutePath() + "\n" );
      }
      return true;
    }
    return false;

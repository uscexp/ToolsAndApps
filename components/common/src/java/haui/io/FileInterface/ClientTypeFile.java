...
public abstract class ClientTypeFile extends BaseTypeFile {
    ...
    public FileInterface[] _listRoots() {
                                                       ...
                                                       // performance!!
        {
            ...
            if (response != null)
                fileInterfaceRoots = (haui.io.FileInterface.FileInterface[]) response.getObject();
        }
    ...
    public FileInterface[] _listFiles(FileInterfaceFilter filter) {
        ...
        if (!isCached() || fileInterfaces == null) {
            ...
            if (response != null)
                fileInterfaces = (haui.io.FileInterface.FileInterface[]) response.getObject();
        }
    ...
    public void deleteOnExit() {
        resetPath();
        sendRequestObject(new RemoteRequestObject("deleteOnExit"));
        readResponseObject();
    }
    ...
    public boolean setReadOnly() {
        resetPath();
        sendRequestObject(new RemoteRequestObject("setReadOnly"));
        RemoteResponseObject response = readResponseObject();
        Boolean blRet = null;
    ...
    protected boolean createPysicallyNewFile() throws IOException {
        resetPath();
        sendRequestObject(new RemoteRequestObject("createNewFile"));
        RemoteResponseObject response = readResponseObject();
        Boolean blRet = null;

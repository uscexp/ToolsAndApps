 ...
 * LockManager (which lets you synchronize several semaphores at once
...
public interface Semaphore
{
   ...
   * ownership. In the case of a <code>CountingSemaphore</code>,
   ...
   *
   * @throws Semaphore.TimedOut if the time out interval expires before

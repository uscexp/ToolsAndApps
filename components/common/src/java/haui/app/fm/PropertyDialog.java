...
/**
 * Module:					PropertyDialog.java<br> $Source: $ <p> Description:    Properties dialog.<br> </p><p> Created:				14.06.2002	by	AE </p><p> Modification:<br> $Log: $ </p><p>
  ...
  extends JExDialog
{
  ...
  public PropertyDialog(Component frame, String title, boolean modal, AppProperties appProps)
  {
  ...
  void jbInit() throws Exception
  {
    ...
    m_jTextFieldExtPath.setToolTipText("Additional path to search commands");
  ...
  public void _init()
  {
    if( m_appProps != null)
    {
      ...
      m_jTextFieldSearchDepth.setText( String.valueOf( FileConnector.SearchDepth));
      FileConnector.TempDirectory = m_strTmpDir;
      FileConnector.ExtPath = m_strExtPath;
    }
  ...
  public void _save()
  {
    ...
    if( m_appProps != null)
    {
      if( m_strTmpDir == null || m_strTmpDir.equals( ""))
      {
        ...
        FileConnector.TempDirectory = null;
      }
      else
      ...
      if( m_strExtPath == null || m_strExtPath.equals( ""))
      {
        ...
        FileConnector.ExtPath = null;
      }
      else
        m_appProps.setProperty( FileInterface.EXTENDEDPATH, m_strExtPath);
      int iOld = FileConnector.SearchDepth;
      try
      {
        int i = Integer.parseInt( m_jTextFieldSearchDepth.getText());
        FileConnector.SearchDepth = i;
        m_appProps.setIntegerProperty( FileInterface.SEARCHDEPTH, new Integer( i));
      }
      catch( NumberFormatException nfex)
      {
        nfex.printStackTrace();
        m_appProps.setIntegerProperty( FileInterface.SEARCHDEPTH, new Integer( iOld));
      }
    }
    m_jPanelProxy._save();
  }
      ...
      else if (cmd == "tmpbrowse")
      {
        ...
        if(returnVal == JFileChooser.APPROVE_OPTION)
        {
          if( chooser.getSelectedFile() != null && chooser.getSelectedFile().getAbsolutePath() != null)
            m_jTextFieldTmpDir.setText( chooser.getSelectedFile().getAbsolutePath());
        }
      }

...
/**
 * Module:      FileManager.java<br> $Source: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\app\\fm\\FileManager.java,v $ <p> Description: JApplet (Application) to manage files and directories local and/or on a remote machine via a cgi script, a ftp connection, ip-socket connection, ...<br> </p><p> Created:     10.11.2000 by AE </p><p>
 * @history      10.11.2000 by AE: Created.<br>  </p><p>  Modification:<br>  $Log: FileManager.java,v $  Revision 1.5  2004-08-31 16:03:01+02  t026843  Large redesign for application dependent outputstreams, mainframes, AppProperties!  Bugfixes to DbTreeTableView, additional features for jDirWork.  Revision 1.4  2004-06-22 14:08:49+02  t026843  bigger changes  Revision 1.3  2003-06-06 10:04:00+02  t026843  modifications because of the moving the 'TypeFile's to haui.io package  Revision 1.2  2003-06-04 15:35:57+02  t026843  bugfixes  Revision 1.1  2003-05-28 14:19:45+02  t026843  reorganisations  Revision 1.0  2003-05-21 16:25:48+02  t026843  Initial revision  Revision 1.11  2003-02-26 09:24:03+01  t026843  Changes due to the changes in SplashDlg  Revision 1.10  2002-09-27 15:28:47+02  t026843  Dialogs extended from JExDialog  Revision 1.9  2002-09-18 11:16:21+02  t026843  - changes to fit extended filemanager.pl  - logon and logoff moved to 'TypeFile's  - startTerminal() added to 'TypeFile's, but only CgiTypeFile (until now) starts the LRShell as terminal  - LRShell changed to work with filemanager.pl  Revision 1.8  2002-09-03 17:08:00+02  t026843  - CgiTypeFile is now full functional.  - Migrated to the extended filemanager.pl script.  Revision 1.7  2002-08-07 15:25:25+02  t026843  Ftp support via filetype added.  Some bugfixes.  Revision 1.6  2002-06-27 16:44:17+02  t026843  saves current dir and connection on exit  Revision 1.5  2002-06-26 12:06:46+02  t026843  History extended, simple bookmark system added.  Revision 1.4  2002-06-17 17:19:19+02  t026843  Zip and Jar filetype read only support.  Revision 1.3  2002-06-11 09:32:52+02  t026843  bugfixes  Revision 1.2  2002-06-06 16:06:07+02  t026843  bugfix with starter menu  Revision 1.1  2002-05-29 11:18:15+02  t026843  Added:  - starter menu  - config starter dialog  - file extensions configurable for right, middle and left mouse button  Changed:  - icons minimized  - changed layout of file ex. and button cmd config dialog  - output area hideable  - other minor changes  bugfixes:  - some minor bugfixes  Revision 1.0  2001-07-20 16:34:24+02  t026843  Initial revision  </p><p>
 * @author       Andreas Eisenhauer  </p><p>
 * @version      v1.0, 2002; $Revision: 1.5 $<br>  $Header: M:\\Dev\\source\\RCS\\M\\Dev\\source\\Bean\\ToolKit2\\haui\\app\\fm\\FileManager.java,v 1.5 2004-08-31 16:03:01+02 t026843 Exp t026843 $  </p><p>
 * @since        JDK1.2  </p>
 */
...
extends JApplet
{
  ...
  //OutputThread m_ot;
  Vector m_vecBookmarks = new Vector();
  //AppProperties m_appProps = new AppProperties();
  AppProperties m_dimProps = new AppProperties();
  Vector m_starterCmd = new Vector();
  Vector m_starterMenuItems = new Vector();
  HashMap m_bookmarkMenuItems = new HashMap();
  HashMap m_bookmarkSubMenuItems = new HashMap();
  ...
  public FileManager()
  {
    ...
    try
    {
      ...
      m_sd.setHeadFont(new Font("DialogInput", Font.BOLD|Font.ITALIC, 24));
  ...
  public void init()
  {
    try
    {
      ...
      m_jshell.getShellEnv().setStreamContainer( m_jTextAreaOut.getStreamContainer());
      m_jPanelFileViewLeft = new FileInfoPanel( m_jshell, false, m_appProps);
      m_jPanelFileViewRight = new FileInfoPanel( m_jshell,true, m_appProps);
      ...
      GlobalApplicationContext.instance().setOutputPrintStream(m_jshell.getOut());
      GlobalApplicationContext.instance().setErrorPrintStream(m_jshell.getOut());
    }
    catch(Exception e)
    {
  ...
  private void jbInit() throws Exception
  {
    ...
    m_jButtonOutClear.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "clearout.gif"));
    ...
    m_jButtonOutLarge.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "largeout.gif"));
    ...
    m_jButtonOutput.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "hideout.gif"));
    ...
    m_jButtonProps.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "preferences16.gif"));
    ...
    m_jButtonExit.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "exit16.gif"));
    ...
    m_jMenuItemProps.setIcon( ResouceManager.getCommonImageIcon( APPNAME, "preferences16.gif"));
    ...
    m_jMenuItemCompare.setIcon( ResouceManager.getCommonImageIcon( APPNAME, "compare.gif"));
    //m_jCheckBoxMenuItemAutoLogon.setText("Auto logon");
    //m_jCheckBoxMenuItemAutoLogon.setActionCommand("autologon");
    //m_jCheckBoxMenuItemAutoLogon.setAccelerator(KeyStroke.getKeyStroke( KeyEvent.VK_A, Event.CTRL_MASK));
    ...
    //m_jCheckBoxMenuItemDiff.setAccelerator(KeyStroke.getKeyStroke( KeyEvent.VK_D, Event.CTRL_MASK));
    ...
    m_jButtonConfigAll.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "confconnect.gif"));
    ...
    m_jButtonConfig.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "config.gif"));
    m_jButtonHistLeft.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "lbutakt.gif"));
    ...
    m_jButtonHistRight.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "rbutakt.gif"));
    ...
    m_jButtonCopy.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "copy.gif"));
    ...
    m_jButtonMove.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "move.gif"));
    ...
    m_jButtonMkDir.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "newfolder.gif"));
    ...
    m_jButtonDelete.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "delete.gif"));
    ...
    m_jButtonRefresh.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "refresh.gif"));
    m_jButtonTerm.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "term.gif"));
    ...
    m_jButtonBsh.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "bshterm.gif"));
    ...
    m_jMenuItemAddBookmark.setAccelerator(KeyStroke.getKeyStroke( KeyEvent.VK_B, Event.CTRL_MASK));
    ...
    m_jMenuItemConfigAll.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "confconnect.gif"));
    m_jMenuItemConfig.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "config.gif"));
    ...
    m_jMenuItemCopy.setAccelerator( KeyStroke.getKeyStroke( KeyEvent.VK_F5, 0));
    m_jMenuItemCopy.setMnemonic('C');
    m_jMenuItemCopy.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "copy.gif"));
    m_jMenuItemMove.setText("Move");
    m_jMenuItemMove.setActionCommand("Move");
    m_jMenuItemMove.setAccelerator( KeyStroke.getKeyStroke( KeyEvent.VK_F6, 0));
    m_jMenuItemMove.setMnemonic('M');
    m_jMenuItemMove.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "move.gif"));
    m_jMenuItemMkDir.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "newfolder.gif"));
    m_jMenuItemMkDir.setMnemonic('k');
    m_jMenuItemMkDir.setAccelerator(KeyStroke.getKeyStroke( KeyEvent.VK_F7, 0));
    m_jMenuItemMkDir.setActionCommand("MkDir");
    m_jMenuItemMkDir.setText("Make directory");
    m_jMenuItemDelete.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "delete.gif"));
    m_jMenuItemDelete.setMnemonic('D');
    m_jMenuItemDelete.setAccelerator(KeyStroke.getKeyStroke( KeyEvent.VK_F8, 0));
    m_jMenuItemDelete.setActionCommand("Delete");
    m_jMenuItemDelete.setText("Delete");
    m_jMenuItemRefresh.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "refresh.gif"));
    ...
    m_jMenuItemTerm.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "term.gif"));
    m_jMenuItemAll.setMnemonic((int)'A');
    m_jMenuItemAll.setActionCommand("all");
    m_jMenuItemAll.setText("All");
    m_jMenuItemAll.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "clearout.gif"));
    m_jMenuItemFilter.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "clearout.gif"));
    ...
    m_jMenuItemSearch.setAccelerator(KeyStroke.getKeyStroke( KeyEvent.VK_F, Event.CTRL_MASK));
    ...
    m_jMenuItemExit.setIcon( ResouceManager.getCommonImageIcon( APPNAME, "exit16.gif"));
    ...
    m_jMenuItemClear.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "clearout.gif"));
    ...
    m_jMenuItemLarge.setIcon( ResouceManager.getCommonImageIcon( APPNAME, "largeout.gif"));
    m_jMenuItemLarge.setText("Large output window");
    m_jMenuItemLarge.setActionCommand("Large");
    m_jMenuItemLarge.setAccelerator( KeyStroke.getKeyStroke( KeyEvent.VK_L, Event.CTRL_MASK));
    m_jMenuItemLarge.setMnemonic((int)'L');
    m_jMenuView.add(m_jMenuItemLarge);
    m_jMenuItemOutput.setIcon(ResouceManager.getCommonImageIcon( APPNAME, "hideout.gif"));
    m_jMenuItemOutput.setText("hide/show output window");
    m_jMenuItemOutput.setActionCommand("output");
    m_jMenuItemOutput.setAccelerator( KeyStroke.getKeyStroke( KeyEvent.VK_O, Event.CTRL_MASK));
  ...
  public FileInfoPanel getActiveFileInfoPanel()
  {
    ...
    else if( m_jPanelFileViewRight != null && m_jPanelFileViewRight.isActive())
  ...
  class LisAction implements ActionListener
  {
    public void actionPerformed( ActionEvent event)
    {
      ...
      {
        CommandClass cmdCls = CommandClass.searchCommand( m_starterCmd, cmd, CommandClass.NO);
        ...
        if( !blSuccess)
        {
          ...
          {
            if( m_vecBookmarks.elementAt( i) == null)
              break;
            if( cmd.equals( ((BookmarkInfo)m_vecBookmarks.elementAt( i)).toString()))
            {
              BookmarkInfo bi = (BookmarkInfo)m_vecBookmarks.elementAt( i);
  ...
  public void socketServer()
  {
    SocketTypeServerFileInterfaceConfiguration configuration = new SocketTypeServerFileInterfaceConfiguration(
        SocketTypeServerFileInterfaceConfiguration.DEFAULTPORT, null, FileManager.APPNAME, m_appProps, true);
    GeneralFileInterfaceConfiguration generalFileInterfaceConfiguration = new GeneralFileInterfaceConfiguration( APPNAME,
        m_appProps, true);
    SocketTypeServer sts = new SocketTypeServer( new NormalFile( ".", null, generalFileInterfaceConfiguration),
        configuration);
    sts.setShellEnv( m_jshell.getShellEnv());
    SocketTypeServerDialog ftsd = new SocketTypeServerDialog( this, "Direct link socket server", false, sts, APPNAME);
  ...
  {
    CommPortTypeServerFileInterfaceConfiguration commPortTypeServerFileInterfaceConfiguration =
      new CommPortTypeServerFileInterfaceConfiguration( null, null, APPNAME, m_appProps, true);
    GeneralFileInterfaceConfiguration generalFileInterfaceConfiguration = new GeneralFileInterfaceConfiguration( APPNAME,
        m_appProps, true);
    CommPortTypeServer cpts = new CommPortTypeServer( new NormalFile( ".", null, generalFileInterfaceConfiguration),
        commPortTypeServerFileInterfaceConfiguration);
    cpts.setShellEnv( m_jshell.getShellEnv());
    CommPortTypeServerDialog ftsd = new CommPortTypeServerDialog( this, "Direct link comm port server", false, cpts, APPNAME);
  ...
  public void removeStarterMenus()
  {
    ...
    {
      JMenuItem mi = (JMenuItem)m_starterMenuItems.elementAt( i);
      m_jMenuStarter.remove( mi);
    }
    m_starterMenuItems.removeAllElements();
  }
  ...
  public void initStarterMenus()
  {
    ...
    {
      CommandClass cmd = (CommandClass)m_starterCmd.elementAt( i);
  ...
  {
    FileFilterDialog ffd = new FileFilterDialog( this, "Filefilter", true, m_appProps);
    ffd.setVisible( true);
    if( !ffd.isCanceled())
    {
      FileInfoPanel fip = getActiveFileInfoPanel();
  ...
  {
    FileInfoPanel fip = getActiveFileInfoPanel();
    FileSearchDialog fsd = new FileSearchDialog( this, "File search", false, APPNAME, fip, m_appProps);
    fsd.setVisible( true);
  }
  ...
  {
    Set sKeys = m_bookmarkMenuItems.keySet();
  ...
  {
    Vector vecConnIds = getConnectionIdsFromBookmarks();
    for( int i = 0; i < vecConnIds.size(); i++)
    {
      BookmarkInfo biConnId = (BookmarkInfo)vecConnIds.elementAt( i);
      JMenu sub = new JMenu( biConnId.getConnectionId());
      m_bookmarkSubMenuItems.put( biConnId.getConnectionId(), sub);
      m_jMenuBookmark.add( sub);
      Vector vecBookms = getBookmarksWithConnectionId( biConnId.getConnectionId());
      for( int j = 0; j < vecBookms.size(); ++j)
      {
        BookmarkInfo biBookm = ( BookmarkInfo )vecBookms.elementAt( j );
  ...
  protected Vector getConnectionIdsFromBookmarks()
  {
    ...
    for( int i = 0; i < m_vecBookmarks.size(); i++)
    {
      ...
      {
        BookmarkInfo biTmp = (BookmarkInfo)vecRet.elementAt( j);
        if( biTmp.getConnectionId().equalsIgnoreCase( bi.getConnectionId()))
        {
          blFound = true;
          break;
        }
  ...
  protected Vector getBookmarksWithConnectionId( String strConnId)
  {
    Vector vecRet = new Vector();
    ...
    for( int i = 0; i < m_vecBookmarks.size(); i++)
    {
      bi = (BookmarkInfo)m_vecBookmarks.elementAt( i);
      blFound = false;
  ...
  public void setBookmarks( Vector vecBookmarks)
  {
  ...
  public void addBookmark()
  {
    ...
    BookmarkInfo bi = new BookmarkInfo( strConnId, fip.getFileInfoTable().getFileInterface().getAbsolutePath());
  ...
  {
    EditBookmarkInfoDialog dlg = new EditBookmarkInfoDialog( this, "Edit Bookmarks", true, (Vector)m_vecBookmarks.clone());
    dlg.setVisible( true);
    if( dlg.isOk())
    {
      removeBookmarkMenus();
   ...
   */
  public Vector getBookmarkVector()
  {
  ...
  {
    removeStarterMenus();
    ConfigFileExtCommandDialog dlg = new ConfigFileExtCommandDialog( this, "Config starter commands",
      true, m_starterCmd);
    dlg.hideForStarter();
    dlg.setVisible( true);
  ...
  {
    if( m_dimProps.load( ConfigPathUtil.getCurrentReadPath( APPNAME, DIMFILENAME)))
    {
      int iLocX = m_dimProps.getIntegerProperty( DIMLOCX).intValue();
      int iLocY = m_dimProps.getIntegerProperty( DIMLOCY).intValue();
      int iWidth = m_dimProps.getIntegerProperty( DIMWIDTH).intValue();
      int iHeight = m_dimProps.getIntegerProperty( DIMHEIGHT).intValue();
      boolean blOutVis = m_dimProps.getBooleanProperty( DIMOUTVIS);
      GlobalApplicationContext.instance().getRootComponent().setSize( iWidth, iHeight);
      GlobalApplicationContext.instance().getRootComponent().setLocation( iLocX, iLocY);
    ...
    {
      GlobalApplicationContext.instance().getRootComponent().setSize( 800, 600);
      Dimension d = Toolkit.getDefaultToolkit().getScreenSize();
      GlobalApplicationContext.instance().getRootComponent().setLocation(
          (d.width - GlobalApplicationContext.instance().getRootComponent().getSize().width) / 2,
          (d.height - GlobalApplicationContext.instance().getRootComponent().getSize().height) / 2);
    }
  }

  public void _saveDim()
  {
      int iLocX = GlobalApplicationContext.instance().getRootComponent().getX();
      int iLocY = GlobalApplicationContext.instance().getRootComponent().getY();
      int iWidth = GlobalApplicationContext.instance().getRootComponent().getWidth();
      int iHeight = GlobalApplicationContext.instance().getRootComponent().getHeight();
      String strLeftConnId = m_jPanelFileViewLeft.getFileInfoTable().getFileInterface().getId();
      String strLeftDir = m_jPanelFileViewLeft.getFileInfoTable().getAbsolutePath();
      String strRightConnId = m_jPanelFileViewRight.getFileInfoTable().getFileInterface().getId();
      String strRightDir = m_jPanelFileViewRight.getFileInfoTable().getAbsolutePath();
      m_dimProps.setIntegerProperty( DIMLOCX, new Integer( iLocX));
      m_dimProps.setIntegerProperty( DIMLOCY, new Integer( iLocY));
      m_dimProps.setIntegerProperty( DIMWIDTH, new Integer( iWidth));
      m_dimProps.setIntegerProperty( DIMHEIGHT, new Integer( iHeight));
      m_dimProps.setBooleanProperty( DIMOUTVIS, m_jScrollPaneOut.isVisible());
      ...
      m_dimProps.store( ConfigPathUtil.getCurrentSavePath( APPNAME, DIMFILENAME), DIMFILEHEADER);
  }
...
//    String strId;
//    String strPar;
    m_starterCmd = CommandClass.initCommandVector( STARTER, APPNAME, m_appProps);
    m_vecBookmarks = BookmarkInfo.initBookmarkVector( BOOKMARK, m_appProps);

    FileConnector.TempDirectory = m_appProps.getProperty( FileInterface.TEMPDIR);
    FileConnector.ExtPath = m_appProps.getProperty( FileInterface.EXTENDEDPATH);
    Integer iSd = m_appProps.getIntegerProperty( FileInterface.SEARCHDEPTH);
    if( iSd != null)
      FileConnector.SearchDepth = iSd.intValue();
    else
      FileConnector.SearchDepth = 0;
  }
  ...
  void outlarge_actionPerformed(ActionEvent e)
  {
    ...
    {
      m_outDlg = new JDialog( (Frame)null, "Output:", false);
      JScrollPane jScrollPaneOutLarge = new JScrollPane();
      if( m_jTextAreaOutLarge == null)
        m_jTextAreaOutLarge = new JTextArea();
      m_jTextAreaOutLarge.setEditable(false);
      ...
      m_outDlg.addWindowListener(new WindowAdapter()
      {
        public void windowClosing(WindowEvent e)
        {
          ...
          if( m_ot != null)
            m_ot.setTextArea( m_jTextAreaOut);
          super.windowClosing( e);
        }
      });
    }
    if( m_outDlg != null && !m_outDlg.isVisible())
    {
      m_jTextAreaOutLarge.setText( m_jTextAreaOut.getText());
      m_jTextAreaOutLarge.setCaretPosition( m_jTextAreaOutLarge.getText().length());
      m_outDlg.toFront();
      if( m_ot != null)
        m_ot.setTextArea( m_jTextAreaOutLarge);
      m_jTextAreaOut.setText( "");
      m_outDlg.setVisible( true);
    }
    */
  ...
  void onSync()
  {
    JExDialog dlg = FileSyncPanel.createSyncDialog( this, m_jPanelFileViewLeft, m_jPanelFileViewRight,
      APPNAME, m_appProps);
    dlg.setModal( false);
    dlg.setVisible( true);
  }
  ...
  {
    if( m_propsDlg == null)
      m_propsDlg = new PropertyDialog( this, "Properties", true, m_appProps);
  ...
  void calcsize_actionPerformed(ActionEvent e)
  {
    ...
    if( fip != null)
    {
      FileInterface[] fis = fip.getFileInfoTable().getSelectedFileInterfaces();
      long[] lFiSel = FileConnector.lengthAndCountOfFiles( fis, null, true );
      ...
      JOptionPane.showMessageDialog( fip, strbuf.toString(), "Calc. size ...",
  ...
  {
    FileInterface fi1 = getInactiveFileInfoPanel().getFileInfoTable().getSelectedFileInterface();
    FileInterface fi2 = getActiveFileInfoPanel().getFileInfoTable().getSelectedFileInterface();

    if( fi1 != null && fi2 != null && !fi1.isDirectory() && !fi2.isDirectory())
    {
    ...
    {
      JOptionPane.showMessageDialog( this, "Please select two files!", "Compare", JOptionPane.WARNING_MESSAGE);
    }
  }
  ...
  public void _save()
  {
    if( m_appProps != null)
    {
      ...
      String strUrlUsr = m_appProps.getProperty( GlobalApplicationContext.URLUSER);
      m_appProps.remove( GlobalApplicationContext.URLUSER);
      String strUrlPwd = m_appProps.getProperty( GlobalApplicationContext.URLPASSWORD);
      ...
      if( strProxyPwd != null)
        m_appProps.setProperty( GlobalApplicationContext.PROXYPASSWORD, strProxyPwd);
      if( strUrlUsr != null)
        m_appProps.setProperty( GlobalApplicationContext.URLUSER, strUrlUsr);
      if( strUrlPwd != null)
        m_appProps.setProperty( GlobalApplicationContext.URLPASSWORD, strUrlPwd);
    }
    //System.out.println( "save config");
    m_jshell.getShellEnv().getOut().println( "save config");
    getRight()._save();
    if( !getLeft().getFileInfoTable().getFileInterface().getId().equals(
      getRight().getFileInfoTable().getFileInterface().getId()))
      getLeft()._save();
  }
  ...
  public void _exec( CommandClass cmd)
  {
    ...
    FileInterface fiSource = fip.getFileInfoTable().getSelectedFileInterface();
    FileInterface fiStartDir = null;
    String strStartDir = cmd.getCompleteStartDir( fiSource, fipTarget.getFileInfoTable().getAbsolutePath());
    ...
    if( strStartDir != null && !strStartDir.equals( ""))
      fiStartDir = FileConnector.createFileInterface( strStartDir, null, false, fic);
    else
      fiStartDir = FileConnector.createFileInterface( ".", null, false, fic);
    strCmd = cmd.getCompleteCommand( fiSource, fipTarget.getFileInfoTable().getAbsolutePath());
    if( strCmd != null)
    {
      strCmd = strCmd.trim();
    ...
    try
    {
      ...
      {
        fiStartDir.exec( null, cmd, m_jshell.getShellEnv().getOut(), m_jshell.getShellEnv().getErr(), null );
    ...
    try
    {
      ...
      if( proc != null)
      {
        ProcessOutputThread pot = new ProcessOutputThread( proc, true, true);
        pot.start();
      }
    }
  ...
  /*
  public void resetInputOutputStreams()
  {
    synchronized( m_jshell)
    {
      JShell.setMultiAppMode( false);
      m_ot.close();
      m_ot.init();
  ...
  */
  ...
  public static void main(String[] args)
  {
    ...
    frame.setIconImage( (new ImageIcon(haui.app.fm.FileInfoPanel.class.getResource("jdw.gif"))).getImage());
    applet.init();
  ...
  static
  {
    try
    {
      GlobalApplicationContext.instance().addApplicationClass(Class.forName( "haui.app.fm.FileManager"));

...
public class FileInfo {
    ...
    public Object clone() {
        Object cm = null;
        if (m_connObj != null) {
            if (m_connObj instanceof FtpConnectionObject) {
                cm = (FtpConnectionObject) m_connObj;
            }
        ...
        if (isLocal()) {
            FileInterfaceConfiguration fic = FileConnector.createFileInterfaceConfiguration(null, 0, null, m_connObj, 0, 0, m_strAppName, m_appProps, true);
    ...
    public BufferedOutputStream getBufferedOutputStream(String strNewPath) throws IOException {
        if (m_fCurrent != null)
    ...
    public boolean delete() {
        ...
        if (!blRet)
            JOptionPane.showMessageDialog(GlobalApplicationContext.instance().getRootComponent(), "Can't delete file!", "Info", JOptionPane.WARNING_MESSAGE);
        return blRet;
    }
     ...
     *            CommandClass
     */
    public void exec(String strTargetPath, CommandClass cmd, OutputStream osOut, OutputStream osErr, InputStream is) throws IOException {
    ...
    public boolean copy(FileInfo finfoDest, String strNewPath, int mode) {
        ...
        if (!blRet)
            JOptionPane.showMessageDialog(GlobalApplicationContext.instance().getRootComponent(), "Can't copy file!", "Info", JOptionPane.WARNING_MESSAGE);
        return blRet;
    }
     ...
     */
    void copyFile(byte buffer[], int iLen, BufferedOutputStream bo) throws IOException {

...
public abstract class ShellFolder implements FileInterface {
	...
	ShellFolder(ShellFolder parent, String pathname,
		...
		current = FileConnector.createFileInterface(
				(pathname != null) ? pathname : "ShellFolder", parentPath,
				false, fic);
		this.parent = parent;
	}
	...
	/**
	 * This method must be implemented to make sure that no instances of
	 * <code>ShellFolder</code> are ever serialized. If
	 * <code>isFileSystem()</code> returns <code>true</code>, then the object
	 * should be representable with an instance of
	 * <code>java.io.FileInterface</code> instead. If not, then the object is
	 * most likely depending on some internal (native) state and cannot be
	 * serialized.
	 * 
	 * @returns a <code>java.io.FileInterface</code> replacement object, or
	...
	/**
	 * Returns the path for this object's parent, or <code>null</code> if this
	 * object does not name a parent folder.
	 * 
	...
	/**
	 * Returns a FileInterface object representing this object's parent, or
	 * <code>null</code> if this object does not name a parent folder.
	 * 
	 * @return a FileInterface object representing this object's parent, or
	 *         <code>null</code> if this object does not name a parent folder
	 * 
	...
	/**
	 * @return The shell folder linked to by this shell folder, or null if this
	 *         shell folder is not a link
	 */
	...
	public int compareTo(FileInterface file2) {
		if (file2 == null
				|| !(file2 instanceof ShellFolder)
				|| ((file2 instanceof ShellFolder) && ((ShellFolder) file2)
						.isFileSystem())) {
	...
	static {
		// Class managerClass =
		// (Class)Toolkit.getDefaultToolkit().getDesktopProperty("Shell.shellFolderManager");
		Class managerClass = null;
		if (managerClass == null) {
			managerClass = ShellFolderManager.class;
		}
		try {
			shellFolderManager = (ShellFolderManager) managerClass
					.newInstance();
	 ...
	 */
	public static ShellFolder getShellFolder(FileInterface file)
	...
	/**
	 * Does <code>dir</code> represent a "computer" such as a node on the
	 * network, or "My Computer" on the desktop.
	 */
	 ...
	 */
	public static FileInterface getNormalizedFile(FileInterface f)
			throws IOException {
	...
	/**
	 * Returns true if folder allows creation of children. True for the
	 * "Desktop" folder, but false for the "My Computer" folder.
	 */
	 ...
	 * 
	 * @see
	 * haui.io.FileInterface.FileInterface#_listFiles(haui.io.FileInterface.
	 * filter.FileInterfaceFilter)
	 */
	 ...
	 * @see
	 * haui.io.FileInterface.FileInterface#_listFiles(haui.io.FileInterface.
	 * filter.FileInterfaceFilter, boolean)
	 */
	public FileInterface[] _listFiles(FileInterfaceFilter filter,
	 ...
	 * 
	 * @see
	 * haui.io.FileInterface.FileInterface#copyFile(java.io.BufferedOutputStream
	 * )
	 */
	 ...
	 * @see
	 * haui.io.FileInterface.FileInterface#copyFile(java.io.BufferedOutputStream
	 * , haui.components.CancelProgressDialog)
	 */
	 ...
	 * (non-Javadoc)
	 * 
	 * @see haui.io.FileInterface.FileInterface#exec(java.lang.String,
	 * haui.util.CommandClass, java.io.OutputStream, java.io.OutputStream,
	 * java.io.InputStream)
	 */
	 ...
	 * 
	 * @see
	 * haui.io.FileInterface.FileInterface#getBufferedOutputStream(java.lang
	 * .String)
	 */
	 ...
	 * 
	 * @see
	 * haui.io.FileInterface.FileInterface#setCurrentProcess(java.lang.Process)
	 */
	 ...
	 * 
	 * @see
	 * haui.io.FileInterface.FileInterface#setFileInterfaceConfiguration(haui
	 * .io.FileInterface.configuration.FileInterfaceConfiguration)
	 */

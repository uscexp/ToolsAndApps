...
/**
 * Allows uniform manipulation with FTP files. Equivalent for File object. <P><B>Only absolute pathnames are supported!</B></P>
 ...
 * @see  java.io.File
 */
public class FtpFile implements CoFile {
  ...
  {
    return ( access.charAt( 0 ) == FOLDER );
  }

  public boolean isFile()
  {
    return ( access.charAt( 0 ) == FILE );
  }

  ...
  extends JShellCommandDefault
{
  ...
  {
    setCommand( new JShellCommandProcessor( "help", jse));
  ...
  public int processCommand(JShellEnv jse, JShellCommandProcessor jscp) throws haui.app.Shell.engine.JShellException
  {
    ...
    else if( strArgs != null  && strArgs.length == 1)
    {
      ...
      JShellCommandProcessor jscpCmd = new JShellCommandProcessor( strArg, jse);
      jse.getCommandList().usage( jse, jscpCmd);
      iStatus = JShellEnv.OKVALUE;
    }
